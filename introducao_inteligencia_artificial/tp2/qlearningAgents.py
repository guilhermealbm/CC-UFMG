...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        best_action = [action for action in self.getLegalActions(state) if self.getQValue(state, action) == best_value]
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        correction = reward + discount_value - self.getQValue(state, action)
